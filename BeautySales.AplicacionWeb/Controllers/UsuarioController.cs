...
using BeautySales.AplicacionWeb.Models.ViewModels;
using BeautySales.AplicacionWeb.Utilidades.Response;
...
namespace BeautySales.AplicacionWeb.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        //Metodos para las peticiones HTTP

        [HttpGet]
        public async Task<IActionResult> ListaRoles()
        {
            List<VMRol> vmListaRoles = _mapper.Map<List<VMRol>>(await _rolServicio.Lista()); //Creo una lista de tipo rol y se convierte a una vista de tipo view model rol
