...
namespace BeautySales.BLL.Implementacion
{
    ...
    {
        //Agrego todos los servicios que usare en esta clase
        ...
        public async Task<Usuario> Crear(Usuario entidad, Stream Foto = null, string NombreFoto = "", string UrlPlantillaCorreo = "")
        {
            ...
            //Logica para crear en caso de que no exista
            try
            {
        ...
        public async Task<Usuario> ObtenerPorCredenciales(string correo, string clave)
        {
            ...
            string clave_encriptada = _utilidadesService.ConvertirSha256(clave); //Encriptar la clave
        ...
        public async Task<bool> GuardarPerfil(Usuario entidad)
        {
            try
            {
                //Verificar si el usuario existes
        ...
        public async Task<bool> CambiarClave(int IdUsuario, string ClaveActual, string ClaveNueva)
        {
            try
            {
                ...
                if (usuario_encontrado == null)
                    throw new TaskCanceledException("El usuario no existes");
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (usuario_encontrado == null)
                    throw new TaskCanceledException("No se encuentra ningun usuario asociado al correo");
